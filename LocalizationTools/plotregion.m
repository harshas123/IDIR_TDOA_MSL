function h=plotregion(A,b,lb,ub,c,transp,points,linetyp,start_end)
...
if iscell(A)
    ...
    if n==2
        ...
        [sooo,ind3]=sort(costhe);
        h(i)=patch(X(1,ind3+1)',X(2,ind3+1)',c);
        set(h(i),'FaceAlpha',transp);
    ...
    elseif n==3
        ...
        for i=1:m
            ...
            if lind2>0
                ...
                [sooo,ind3]=sort(costhe);
                h(i)=patch(X(1,ind2(ind3))',X(2,ind2(ind3))',X(3,ind2(ind3))',c);
                set(h(i),'FaceAlpha',transp);
            end
        end
    else
